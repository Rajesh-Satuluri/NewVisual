/* ============================================================
   ...
   Modules self-register via SolverViz.registerModule({...}).
  ...
  Router.prototype._renderComingSoon = function (id, title) {
    ...
    this.container.innerHTML =
      '<div class="module-header animate-fade-in-up">' +
        '<div class="module-eyebrow">o9 Solver Visualizer</div>' +
      ...
      '<div class="callout tip animate-fade-in">' +
        ...
        'the <a href="#business-scenario">Business Scenario</a> — both are fully interactive.</div>' +
      "</div>";
  };
